REM police dont les frais n ont pas ete executes

set lines 150
set pages 10000
set COLSEP ';'

ttitle 'POLICE DONT LES FRAIS N ONT PAS ETE EXECUTES'

column PR_CODE format a40 trunc
column IDENTIFIER format a40 trunc
