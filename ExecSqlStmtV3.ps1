...
connectStr is used to specify TNS database string. Mandatory
...
.Example
execSqlStmt3 -connectStr ORLSOL00_prdbak -Schema clv61re7 -Passwd Mo2pace -stmtFile c:\temp\UpdateEmp.sql -stmtOut c:\temp\UpdateEmp.out -mode false
...
$cnx = "$schema/$passwd@$connectStr"

$sql | sqlplus $cnx > $stmtOut
